...
foreign lib {
	...
	@(link_name="ImGui_GetBackgroundDrawList") GetBackgroundDrawList :: proc() -> ^DrawList --- // this draw list will be the first rendered one. Useful to quickly draw shapes/text behind dear imgui contents.
	@(link_name="ImGui_GetForegroundDrawList") GetForegroundDrawList :: proc() -> ^DrawList --- // this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents.

...
foreign lib {
	...
	@(link_name="ImGui_IsWindowChildOf")                            IsWindowChildOf                            :: proc(window: ^Window, potential_parent: ^Window, popup_hierarchy: bool) -> bool ---
	...
	@(link_name="ImGui_SetWindowParentWindowForFocusRoute")         SetWindowParentWindowForFocusRoute         :: proc(window: ^Window, parent_window: ^Window)                                   ---
	...
	@(link_name="ImGui_GetForegroundDrawListImGuiWindowPtr")   GetForegroundDrawListImGuiWindowPtr   :: proc(window: ^Window) -> ^DrawList                                              --- // This seemingly unnecessary wrapper simplifies compatibility between the 'master' and 'docking' branches.
	...
	@(link_name="ImGui_CollapseButton")          CollapseButton          :: proc(id: ID, pos: Vec2) -> bool                                                                                                  ---
